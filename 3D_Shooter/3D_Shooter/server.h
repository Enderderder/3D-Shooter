...
public:
	...
	//Displays curent online users on server
	void CurrentUsers(TPacket _packetToSend);

	//vaiable to create strings
	char charNameptr[60];
...
private:
	...
	const char * strcompereHelp = " !?";
	const char * stCompereQuit = " !q";
